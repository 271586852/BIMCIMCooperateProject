<template>
    ...
    <div class="add-layer" id="polylineWindow" style="display: none;">
        ...
        <div>
            <label>geojson:</label>
            <el-button  @click="handleButtonClick">选择文件</el-button>
            <el-input type="textarea"  :autosize="{ minRows: 5, maxRows: 12 }" v-model="geojson" step="0.01" placeholder="请输入geojson或者输入geojson的线上地址" />
        </div>
        <div>
            <label>高程:</label>
