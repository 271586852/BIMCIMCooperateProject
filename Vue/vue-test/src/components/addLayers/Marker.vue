<template>
    <!-- Marker窗口 -->
    <div class="add-layer" id="markerWindow" style="display: none; max-height:83vh ;overflow:auto">
        <div class="labelbtn">
            <i class="el-icon el-notification__closeBtn" @click="closeMarkerWindow('markerWindow')"
